...
- market_session_date: 2026-09-08
- generated_at: 2026-09-08T23:46:47+02:00
...
|---|---|---|---|---|---|---|---|
| QQQ | 718.36 | 711.32 | 0.989 | +/-0.50% | 658.32 | true | sopra il buffer superiore |
| Nasdaq Composite (IXIC) | 26421.40 | 26034.95 | 1.484 | +/-0.50% | 24417.77 | true | sopra il buffer superiore |
...
|---|---|---|---|---|---|---|---|---|---|---|
| STX | Seagate Technology Holdings Plc | 904.38 | 57.10 | 6.32 | 1.40 | 26.61 | true | NORMAL | 48.49 | 149.17 |
| MU | Micron Technology Inc | 1000.26 | 57.66 | 5.40 | 0.95 | 25.47 | true | NORMAL | 345.72 | 1372.09 |
| NESR | National Energy Services Reunited Corp | 34.18 | 56.57 | 4.41 | 0.67 | 8.07 | true | NORMAL | 59.07 | 173.86 |
...
|---|---|---|---|---|
| ARXS | 100 | 200 | 1776346200 | 1788874200 |
| BSP | 48 | 200 | 1782912600 | 1788874200 |
| FRVO | 81 | 200 | 1778679000 | 1788874200 |
| HONA | 59 | 200 | 1781530200 | 1788874200 |
| INIO | 66 | 200 | 1780579800 | 1788874200 |
| IOND | 30 | 200 | 1785245400 | 1788874200 |
| LFTO | 66 | 200 | 1780579800 | 1788874200 |
| MWH | 144 | 200 | 1770820200 | 1788874200 |
| QNT | 66 | 200 | 1780579800 | 1788874200 |
| SHAZ | 140 | 200 | 1771425000 | 1788874200 |
| SPCX | 60 | 200 | 1781271000 | 1788874200 |
| XE | 93 | 200 | 1777296600 | 1788874200 |
...
- stato: **FRESH**
- seduta attesa: 2026-09-08
- benchmark autorevole: QQQ (ultima barra 2026-09-08)
  - IXIC: 2026-09-08
  - QQQ: 2026-09-08
- ritardo: 0 giorni di calendario
- ultima barra daily di QQQ = 2026-09-08, coincidente con la seduta attesa
...
- funnel completo: 539 = 47 + 418 + 12 + 58 + 3 + 0
...
- fact legacy: 2026-07-31 (39 giorni), entro la freschezza
- fact shadow selezionato: 2026-07-31
- confronto 6M: 3.9305%
- motivo: confronto 2026-01-27 -> 2026-07-31: intervallo 185 giorni
- fatti rifiutati:
  - 2026-01-27 val=218073067.0 form=10-Q eta=224 motivi=STALE_BEYOND_FRESHNESS_LIMIT
...
Shares XBRL:
- stato dato shadow: FRESH
- fact legacy: 2026-06-17 (83 giorni), entro la freschezza
- fact shadow selezionato: 2026-06-17
- confronto 6M: 0.3451%
- motivo: confronto 2025-12-10 -> 2026-06-17: intervallo 189 giorni
- fatti rifiutati:
  - 2025-12-10 val=1125509261.0 form=10-Q eta=272 motivi=STALE_BEYOND_FRESHNESS_LIMIT
...
Shares XBRL:
- stato dato shadow: FRESH
- fact legacy: 2026-06-30 (70 giorni), entro la freschezza
- fact shadow selezionato: 2026-06-30
- confronto 6M: 0.0641%
- motivo: confronto 2025-12-31 -> 2026-06-30: intervallo 181 giorni
- fatti rifiutati:
  - 2025-12-31 val=100787173.0 form=10-K eta=251 motivi=STALE_BEYOND_FRESHNESS_LIMIT
...
|---|---|---|---|---|---|
| NVDA | 42.00 | 0.92 | 56.15 | 0.79 | 4.00 |
...
|---|---|---|---|---|---|---|---|
| SMTC | 85.00 | fallisce il gate no_extended_move_10d | no_extended_move_10d | 1.53 | 65.03 | 16.64 | 9.06 |
| AMD | 80.00 | fallisce il gate ema21_above_ema50 | ema21_above_ema50 | 1.60 | 57.03 | 4.63 | 15.62 |
| ASML | 60.00 | fallisce il gate rsi14 | rsi14 | 1.17 | 53.88 | 1.37 | 13.32 |
...
- esclusioni fondamentali: -418 → 74 allo stadio tecnico
- esclusioni tecniche: -70
- **shortlist: 3** (cap 3)

Gate piu' selettivi (causa primaria): revenue_growth 275, eps_growth 68, operating_margin 41, price_above_sma50 37, eps_next_year 34.
Dettaglio completo in `funnel_latest.json`.

> **FUNNEL_RECONCILIATION_FAILED**
>
> Somma dei bucket terminali: 538 contro un universo di 539 (differenza -1).
...
| FUNDAMENTAL_EXCLUSION | 418 |
| DATA_INSUFFICIENT | 12 |
| TECHNICAL_EXCLUSION | 58 |
| PROMOTED | 3 |
| RUNTIME_ERROR | 0 |
| **totale riconciliato** | **538** |
| universo iniziale | 539 |
...
Esito: **FUNNEL_RECONCILIATION_FAILED**. I conteggi non vanno considerati affidabili finche' l'identita' non chiude.
...
- azioni in circolazione: **PASS**
  - misura: 2026-01-27 -> 2026-07-31 · intervallo 185 g (target 180, scarto 5) · corrente vecchia di 39 g · variazione +3.931% · confidence HIGH
...
- confidenza misura: HIGH
- azioni in circolazione: **PASS**
  - misura: 2025-12-10 -> 2026-06-17 · intervallo 189 g (target 180, scarto 9) · corrente vecchia di 83 g · variazione +0.345% · confidence HIGH
...
- confidenza misura: HIGH
- azioni in circolazione: **PASS**
  - misura: 2025-12-31 -> 2026-06-30 · intervallo 181 g (target 180, scarto 1) · corrente vecchia di 70 g · variazione +0.064% · confidence HIGH
...
- TradingView MCP: ok - dati tecnici raccolti durante il run (2026-09-08T23:30:05+02:00 -> 2026-09-08T23:46:47+02:00)
- Finviz (finvizfinance): OK - universo e fondamentali recuperati alle 2026-09-08T23:30:26+02:00 (finviz_mcp_status: NOT_CONFIGURED)
